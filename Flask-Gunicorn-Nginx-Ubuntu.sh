...
Introduction
In this guide, we will be setting up a simple Python application using the Flask web service on Ubuntu 14.04. The article aims to provide guideline about how to set up the Gunicorn application server to launch the application and Nginx to act as a front end reverse proxy.
